...
#include <time.h>
	...
	double F_DE;
	double CR_DE;
        const char *mutation_strategy_DE;
    ...
    typedef struct {
	int family_slave; /* (1) SS (2) DE (3) LS */
        char *nameMatlab;
...
void familyslave_(void *, int *);

void setoutputmatlabres_(void *, double *, int *);

void setoutputmatlabpen_(void *, double *, int *);
