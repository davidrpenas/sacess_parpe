...
double callfitnessfunctionfortranopenmp_(void *(*fitnessfunction)(double*, void *), void *, double *, int *, double *, double *, double*, int *);

void translation  ( double *, double *, int  );
void detranslation( double *, double *, int  ); 
