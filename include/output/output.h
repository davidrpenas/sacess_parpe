...
void printadaptationmaster_(void *, int *, int *, double *, int *, int *, int *, int *, double *, int *, int *, double *, double *, int *);
void printadaptation_(void *, double *, int *, int *, double *, int *, int *, int *, int *, int *);
...
void printputcheckmasterlog_(void *, double *new_, double * );
...
void printcomenewsolutionslavelog_(void *, double *new_, double *, double *, double * ) ;
void printfinalsendslavelog_(void *, double *new_, double * ) ;
...
void printdescartsolution_(void *,  double *, int  *);
void plot(experiment_total *);
void graphs_message(experiment_total *);
