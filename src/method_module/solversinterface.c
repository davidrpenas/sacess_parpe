...
/*
extern "C"{
	int cess_(void *, void*(*function)(double*,void*), void *, long *, double*);
        int acessdist_(void *, void*(*function)(double*,void*), void *, long *, double*);
        int sacess_(void *, void*(*function)(double*,void*), void *, long *, double*);
        int essm_(void *, void*(*function)(double*,void*), void *, long *, double*);
	int hyper_(void *, void*(*function)(double*,void*), void *, long *, double*);
	int sacde_(void *, void*(*function)(double*,void*), void *, long *, double*);
        int sscattersearch_(void *, void*(*function)(double*,void*), void *, long *, double*);
}
*/
...
if ((*exp).methodScatterSearch != NULL) {
     ...
     idsolver = getnumversion(exp);
		...
		if (exp->execution.NPROC > 1) {
            ...
            //error = cess_((void *) exp, function, (void *) result, &maxfunevals, &(*exp).test.VTR);
#elif defined(INTEL)
            ...
            //error = acessdist_((void *) exp, function, (void *) result, &maxfunevals, &(*exp).test.VTR);
#elif defined(INTEL)
	    ...
	    //error = sacess_((void *) exp, function, (void *) result, &maxfunevals, &(*exp).test.VTR);
#elif defined(INTEL)
            ...
            //error = essm_((void *) exp,  function, (void *) result, &maxfunevals, &(*exp).test.VTR);
#elif defined(INTEL)
            error = modessm_mp_essm_((void *) exp,  function, (void *) result, &maxfunevals, &(*exp).test.VTR);
                ...
                if (exp->execution.NPROC > 1) {
#ifdef GNU
                    error = __modhyper_MOD_hyper((void *) exp, function, (void *) result, &maxfunevals, &(*exp).test.VTR);
		    //error = hyper_((void *) exp, function, (void *) result, &maxfunevals, &(*exp).test.VTR);
#elif defined(INTEL)
                    error = modhyper_mp_hyper_((void *) exp, function, (void *) result, &maxfunevals, &(*exp).test.VTR);
#endif
                } else {
                        perror(error39);
                        exit(0);
                ...
                if (exp->execution.NPROC > 1) {
#ifdef GNU
                    error = __modsacde_MOD_sacde((void *) exp, function, (void *) result, &maxfunevals, &(*exp).test.VTR);
		    //error = sacde_((void *) exp, function, (void *) result, &maxfunevals, &(*exp).test.VTR);
#elif defined(INTEL)
                    error = modsacde_mp_sacde_((void *) exp, function, (void *) result, &maxfunevals, &(*exp).test.VTR);
#endif
                } else {
                        perror(error39);
                        exit(0);
...
int execute_serial_solver(experiment_total *exp, result_solver *result, long maxfunevals,  void*(*function)(double*,void*)) {
    ...
    if ((*exp).methodScatterSearch != NULL) {
            ...
            //error = sscattersearch_((void *) exp,  function, (void *) result, &maxfunevals, &(*exp).test.VTR);
#elif defined(INTEL)
...
int  execute_Solver(experiment_total *exp1, result_solver *result, void*(*function)(double*,void*)){
    ...
    if (isparallel == 1) {
        error = execute_parallel_solver(exp1, result, maxfunevals, function);
    } else {
        error = execute_serial_solver(exp1, result,maxfunevals, function);
    }
    return error;
}
